...
from . import data
from . import html_creator


def display_404_not_found():
    html_str = html_creator.create_start_html(body_class="about")
    html_str += html_creator.create_404_html()
    html_str += html_creator.create_end_html()
...
def display_about():
    html_str = html_creator.create_start_html(body_class="about")
    html_str += html_creator.create_about_html()
    html_str += html_creator.create_end_html()
    print("Content-Type: text/html; charset=utf-8\r\n\r\n", end="")
    print(html_str)
...
def display_author(author_id):
    ...
    """
    html_str = html_creator.create_start_html(body_class="tables")
    if str.isdigit(author_id) and str.isascii(author_id) and int(author_id) > 0:
        ...
        if author is None:
            ...
            html_str += html_creator.create_author_html(author)
    else:
...
def display_authors():
    ...
    html_str = html_creator.create_start_html(body_class="tables")
    html_str += html_creator.create_all_authors_table_html(authors)
    html_str += html_creator.create_end_html()
    print("Content-Type: text/html; charset=utf-8\r\n\r\n", end="")
    print(html_str)
...
def display_book(book_id):
    ...
    if str.isdigit(book_id) and str.isascii(book_id) and int(book_id) > 0:
        ...
        if book is None:
            ...
            html_str += html_creator.create_book_html(book)
    else:
...
def display_books():
    ...
    html_str = html_creator.create_start_html(body_class="tables")
    html_str += html_creator.create_all_books_table_html(books)
    html_str += html_creator.create_end_html()
    print("Content-Type: text/html; charset=utf-8\r\n\r\n", end="")
    print(html_str)
...
def display_narrator(narrator_id):
    ...
    if str.isdigit(narrator_id) and str.isascii(narrator_id) and int(narrator_id) > 0:
        ...
        if narrator is None:
            ...
            html_str += html_creator.create_narrator_html(narrator)
    else:
...
def display_summary():
    summaries = data.get_summary()
    html_str = html_creator.create_start_html(body_class="tables")
    html_str += html_creator.create_summary_html(summaries)
    html_str += html_creator.create_end_html()
    print("Content-Type: text/html; charset=utf-8\r\n\r\n", end="")
    print(html_str)
...
def display_translator(translator_id):
    ...
    if str.isdigit(translator_id) and str.isascii(translator_id) and int(translator_id) > 0:
        ...
        if translator is None:
            ...
            html_str += html_creator.create_translator_html(translator)
    else:
